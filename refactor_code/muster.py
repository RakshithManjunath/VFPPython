...
def generate_muster_shift(db_check_flag, g_current_path, shift_master_df=None):
...
##########################################  end of muster shift logic ######################################################


##########################################  start of muster flexi logic ######################################################


def generate_muster_flexi(db_check_flag,g_current_path):
    table_paths = file_paths(g_current_path)
